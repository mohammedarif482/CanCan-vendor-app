    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--cancan-bg)' }}>
            ...
            <main style={{ maxWidth: 960, margin: '0 auto', padding: '48px 24px' }}>
                <h1 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: 24, letterSpacing: '-0.02em' }}>Privacy Policy</h1>
                <div style={{ marginBottom: 16 }}>
                    <a
                        href="/cancan/privacy.pdf"
                        download
                        style={{
                            display: 'inline-flex',
                            alignItems: 'center',
                ...
                >
                    <p style={{ color: 'var(--cancan-muted)' }}>
                        ...
                        <a href="/cancan/privacy.pdf" download style={{ color: 'var(--cancan-primary-dark)' }}>
